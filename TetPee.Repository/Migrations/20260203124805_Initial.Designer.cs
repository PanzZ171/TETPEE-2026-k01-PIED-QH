...
namespace TetPee.Repository.Migrations
{
    ...
    [Migration("20260203124805_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Inventories", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("TetPee.Repository.Entity.Categogy", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("TetPee.Repository.Entity.ProductCategory", b =>
                {
                    ...
                    b.Property<Guid>("CatecogyId")
                        .HasColumnType("uuid");

                    b.Property<Guid>("CategogyId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Inventories", b =>
                {
                    b.HasOne("TetPee.Repository.Entity.Product", "Product")
                        .WithOne("Inventories")
                        .HasForeignKey("Inventories", "ProductId")
            ...
            modelBuilder.Entity("TetPee.Repository.Entity.Categogy", b =>
                {
                    b.HasOne("TetPee.Repository.Entity.Categogy", "Parent")
                        .WithMany("Children")
            ...
            modelBuilder.Entity("TetPee.Repository.Entity.ProductCategory", b =>
                {
                    b.HasOne("TetPee.Repository.Entity.Categogy", "Categogy")
                        .WithMany("Product_Cate")
            ...
            modelBuilder.Entity("TetPee.Repository.Entity.Storage", b =>
                {
                    b.HasOne("TetPee.Repository.Entity.Storage", null)
                        .WithMany("Storages")
                        .HasForeignKey("StorageId");
                });
